...
Then('the response is a valid JSON object', async function (this: HttpRequestWorld) {
  await this.request();
...
Then('the response is a valid YAML document', async function (this: HttpRequestWorld) {
  await this.request();
