...
Review ONLY the Java test files located directly within the `{project-root}/src/test/java/io/github/mihaly_farkas/spring_cloud_config_server/` directory. Do NOT look into subdirectories or any other folders.
