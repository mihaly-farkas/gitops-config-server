...
chmod +x .github/workflows/continuous-delivery/build-maven.sh
chmod +x .github/workflows/continuous-delivery/prepare-docs.sh
chmod +x .github/workflows/continuous-delivery/run-feature-tests.sh
chmod +x ./mvnw
