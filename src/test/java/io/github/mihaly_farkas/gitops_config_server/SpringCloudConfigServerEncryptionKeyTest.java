...
@SpringBootTest
@ActiveProfiles({"mockmvc_public_github_repo", "mockmvc_encrypt_key", "disable_spring_security"})
@AutoConfigureMockMvc
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class SpringCloudConfigServerEncryptionKeyTest {
  ...
  @DisplayName(
      "When encryption key is configured,"
          + " Spring Cloud Config Server can resolve secret values")
  @SneakyThrows
  void canResolvesSecrets(String endpoint, Map<String, String> expectedValues) {
    // ACT & ASSERT
    mockMvc
  ...
  @Test
  @DisplayName(
      "When encryption key is configured," + " Spring Cloud Config Server encryption status is OK")
  @SneakyThrows
  ...
  @DisplayName(
      "When encryption key is configured,"
          + " Spring Cloud Config Server can encrypt and decrypt secret values")
  @SneakyThrows
