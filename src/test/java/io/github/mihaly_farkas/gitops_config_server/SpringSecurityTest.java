...
import static io.github.mihaly_farkas.gitops_config_server.lib.http.MediaType.APPLICATION_SPRING_BOOT_ACTUATOR_JSON;
...
abstract class SpringSecurityTest extends MockMvcTest {
  ...
  Stream<Arguments> springCloudConfigServerEndpoints() {
    return Stream.of(
        ...
        Arguments.of(
            configServerPrefix + "/gitops_config_server-default.json", OK, APPLICATION_JSON),
        Arguments.of(
