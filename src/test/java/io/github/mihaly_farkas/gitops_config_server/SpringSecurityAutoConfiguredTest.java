...
@ActiveProfiles({"public_github_repo", "all_actuator_endpoints"})
class SpringSecurityAutoConfiguredTest extends SpringSecurityTest {

  @DisplayName(
      "Unprotected endpoints are accessible without authorization when Spring Security is auto-configured")
  ...
  @DisplayName(
      "Protected endpoints are accessible with auto-generated credentials when Spring Security is auto-configured")
  ...
  @DisplayName(
      "Protected endpoints are NOT accessible without authorization when Spring Security is auto-configured")
  @MethodSource("protectedEndpoints")
  @ParameterizedTest(name = "endpoint -> {0}")
  @SneakyThrows
  ...
  @DisplayName(
      "Protected endpoints are NOT accessible with invalid authorization when Spring Security is auto-configured")
  @MethodSource("protectedEndpoints")
  @ParameterizedTest(name = "endpoint -> {0}")
  @SneakyThrows
