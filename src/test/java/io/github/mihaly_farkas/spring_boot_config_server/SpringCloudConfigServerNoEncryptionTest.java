...
class SpringCloudConfigServerNoEncryptionTest extends MockMvcTest {
  ...
  Stream<Arguments> configs() {
    return Stream.of(
        Arguments.of(
            configServerPrefix + "/spring_boot_config_server-default.json",
            Map.of(
                "name", "Spring Boot Config Server Example",
                "description", "Configuration for Spring Boot Config Server Example",
                "invalid", Map.of("secret", "<n/a>"))),
        Arguments.of(
            configServerPrefix + "/spring_boot_config_server-overrides_by_profile.json",
            Map.of(
                "name",
                "Spring Boot Config Server Example (overridden by the 'overrides_by_profile' profile)",
                "description",
                "Configuration for Spring Boot Config Server Example (overridden by the 'overrides_by_profile' profile)",
                "invalid",
                Map.of("secret", "<n/a>"))));
  }
