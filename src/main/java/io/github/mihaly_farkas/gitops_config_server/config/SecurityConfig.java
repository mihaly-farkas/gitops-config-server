...
/**
 * Spring Security configuration for the GitOps Config Server application.
 *
 ...
 *   <li><strong>Disabled Security Chain:</strong> When the {@code disable_spring_security} profile
 *       is active, all requests are permitted without authentication.
 * </ul>
 *
...
public class SecurityConfig {
  ...
  public SecurityFilterChain actuatorHealthSecurityFilterChain(
      ...
      @Value("${gitops-config-server.security.disable-csrf:false}") boolean disableCsrf) {
    log.info(
  ...
  /**
   * Creates a security filter chain for the {@code disable_spring_security} profile.
   *
