...
//   - 1: Connection failed (socket unavailable or permission denied)
//   - 2: Timeout or failed to set connection deadlines
//   - 3: Protocol error (invalid response length or read error)
//   - 4: Unhealthy ('U' or any unexpected byte received)
package main
...
const socketPath = "/app/health.sock"
